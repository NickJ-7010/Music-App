...
} from "./(PeformCommentActionParams)/TranslateCommentParams";
import {
...
export function createValue(partialValue: Partial<$.youtube.PeformCommentActionParams>): $.youtube.PeformCommentActionParams {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.PeformCommentActionParams): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.PeformCommentActionParams {
...
export function encodeBinary(value: $.youtube.PeformCommentActionParams): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.PeformCommentActionParams {
  const result = getDefaultValue();
