...
} from "./(TranslateCommentParams)/Params";
import {
...
export function getDefaultValue(): $.youtube.PeformCommentActionParams.TranslateCommentParams {
  return {
    commentId: "",
    params: undefined,
    targetLanguage: "",
...
export function createValue(partialValue: Partial<$.youtube.PeformCommentActionParams.TranslateCommentParams>): $.youtube.PeformCommentActionParams.TranslateCommentParams {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.PeformCommentActionParams.TranslateCommentParams): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.PeformCommentActionParams.TranslateCommentParams {
...
export function encodeBinary(value: $.youtube.PeformCommentActionParams.TranslateCommentParams): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.PeformCommentActionParams.TranslateCommentParams {
  const result = getDefaultValue();
